...
public class TestPublicarEstablecimiento {
    ...
    public void testRegistrarEstablecimiento() throws OperationFailedException{
        ...
        for(int i=400; i<limite; i++){
            Establecimiento a = new Establecimiento(i, "nombre"+i, i+".123.123-1", "Autonorte"+i, new Time(700), new Time(1800), 2.0,"Puente Aranda", "1234567890", "34523456435454423439");
            listaEsta.add(a);
    ...
    public void testRegistrarHabilitacionEstablecimiento() throws OperationFailedException{
        ...
        for(int i=50; i<limite; i++){
            Establecimiento a = new Establecimiento(i, "nombre"+i, i+"3.123.123-1 sin revisar", "Autonorte"+i, new Time(700), new Time(1800), 2.0,"Puente Aranda", "1234567890", "34329084392084320939");
            listaEsta.add(a);
            logica.registrarEstablecimiento(a);
        }
        ...
        for(int i=50; i<limite; i++){
             logica.habilitarEstablecimiento(i);
             fd= logica.consultarEstablecimientoHabilitado(i);
    ...
    public void testRegistrarSala() throws OperationFailedException {
        ...
        Establecimiento a = new Establecimiento(1, "nombre"+1, "123.123.123-1", "Autonorte"+1, new Time(700), new Time(1800), 2.0,"Puente Aranda", "1234567890", "34323892479823745600");
        logica.registrarEstablecimiento(a);
